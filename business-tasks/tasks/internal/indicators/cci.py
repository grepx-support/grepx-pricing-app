...
# Celery task wrapper
def calculate_cci(period: int = 20, **kwargs) -> Dict[str, Any]:
    """Calculate CCI indicator - Celery task entry point."""
    indicator = CCI(period=period)
    return {"status": "success", "indicator": "CCI", "period": period}
