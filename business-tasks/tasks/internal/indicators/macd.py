...
# Celery task wrapper
def calculate_macd(fast_period: int = 12, slow_period: int = 26, signal_period: int = 9, **kwargs) -> Dict[str, Any]:
    """Calculate MACD indicator - Celery task entry point."""
    indicator = MACD(fast_period=fast_period, slow_period=slow_period, signal_period=signal_period)
    return {"status": "success", "indicator": "MACD", "fast_period": fast_period, "slow_period": slow_period, "signal_period": signal_period}
