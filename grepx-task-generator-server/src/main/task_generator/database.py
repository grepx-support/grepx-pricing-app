...
try:
    from .models import Base, Asset, Resource, Schedule, Sensor, AssetMetadata, CeleryTask
except ImportError:
    # Fallback for absolute import
    from task_generator.models import Base, Asset, Resource, Schedule, Sensor, AssetMetadata, CeleryTask
